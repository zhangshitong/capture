...
final class DecodeFormatManager {
  ...
  static final Collection<BarcodeFormat> DATA_COLUMN_FORMATS = EnumSet.of(BarcodeFormat.DATA_COLUMN);
  static final Collection<BarcodeFormat> DATA_COLUMN_MULTI_FORMATS = EnumSet.of(BarcodeFormat.DATA_COLUMN_MULTI);
